...
export const timeEntryAudits = pgTable("time_entry_audit", {
  ...
  beforeAccountDisplayName: text("before_account_display_name"),
  beforeClientId: uuid("before_client_id"),
  beforeClientDisplayName: text("before_client_display_name"),
  ...
  afterAccountDisplayName: text("after_account_display_name"),
  afterWorkDate: date("after_work_date"),
  afterClientDisplayName: text("after_client_display_name"),
